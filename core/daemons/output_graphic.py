    ...
    def run(self):
        while 1:
            ...
            try:
                ...
                try:
                    self.scr.addstr(5, 1, "dernière touche : ")
                except:
                ...
                self.scr.addstr(5, 19, printable_last_entry, A_NORMAL)
                self.scr.addstr(5, 24, "|| " + self.core.erreurs)

                # on affiche les infos du gant
